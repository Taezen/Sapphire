...
namespace Sapphire::Network::Packets
{
  ...
  */
  enum ServerZoneIpcType : uint16_t
  {
    ...
    EventYield = 0xF2CB, // updated 5.55 hotfix
    //EventYield4 = 0x0000,
    //EventYield8 = 0x0000,
    //EventYield16 = 0x0000,
    //EventYield32 = 0x0000,
    ...
    ShopMessage = 0xF2FC, // updated 5.45 hotfix
  ...
  */
  enum ClientZoneIpcType : uint16_t
  {
    ...
    TradeMultipleReturnEventHander = 0x02E1, // updated 5.58
    ...
    HousingEditExterior = 0x02F7, // updated 5.58
