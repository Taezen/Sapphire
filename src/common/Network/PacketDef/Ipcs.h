...
namespace Sapphire::Network::Packets
{
  ...
  */
  enum ServerZoneIpcType : uint16_t
  {
    ...
    FateSetup = 0x036B, // updated 5.58 hotfix
    ...
    CWFriends = 0x00EE, // updated 5.58 hotfix
    RefreshCWFriend = 0x0251, // updated 5.58 hotfix
    ...
    CWLinkshellList = 0x01AA, // updated 5.58 hotfix
    FellowshipList = 0x00C0, // updated 5.58 hotfix

    CWLinkshellMemberList = 0x03B7, // updated 5.58 hotfix
    ...
    FreeCompanyShortInfo = 0x031F, // updated 5.58 hotfix
    ExamineFreeCompanyInfo = 0x0324, // updated 5.58 hotfix
    FreeCompanyRanks = 0x038B, // updated 5.58 hotfix
    ...
    RetainerInformation = 0x00BA, // updated 5.58 hotfix
    RetainerShortInfo = 0x0290, // updated 5.58 hotfix
    RetainerList = 0x02E9, // updated 5.58 hotfix
    ...
    InventoryTransaction = 0x02F7, // updated 5.58 hotfix
    CurrencyCrystalInfo = 0x0345, // updated 5.58 hotfix

    LeveActiveList = 0x0279, // updated 5.58 hotfix
    LeveCompleteList = 0x0312, // updated 5.58 hotfix
    LeveAllowanceInfo = 0x028E, // updated 5.58 hotfix
    ...
    EventStart = 0x02DA, // updated 5.58 htofix
    ...
    GathererGuide = 0x10C, // updated 5.58 hotfix
    GathererGuideViewedMask = 0x009F, // updated 5.58 hotfix
    CrafterGuide = 0x00F1, // updated 5.58 hotfix
    CrafterGuideViewedMask = 0x009E, // updated 5.58 hotfix

    Mount = 0x01E1, // updated 5.58 hotfix

    DirectorVars = 0x0154, // updated 5.58 hotfix
    DirectorMessage = 0x03DD, // updated 5.58 hotfix - display "LogMessages" with an optional director
    DirectorMessage4 = 0x0287, // updated 5.58 hotfix
    DirectorMessage8 = 0x0388, // updated 5.58 hotfix
    DirectorMessage16 = 0x036D, // updated 5.58 hotfix
    DirectorMessage32 = 0x0189, // updated 5.58 hotfix
    DirectorPopUp = 0x03DF, // updated 5.58 hotfix - display dialogue pop-ups in duties and FATEs, for example, Teraflare's countdown
    ...
    DesynthStats = 0x03E3, // updated 5.58 hotfix
    ...
    DailyQuestFinish = 0x0073, // updatetd 5.58 hotfix
  ...
  */
  enum ClientZoneIpcType : uint16_t
  {
    ...
    ReqAddPlayerToBlacklist = 0x033F, // updated 5.58 hotfix
    ...
    ReqCWFriendsHandler = 0x021F, // updated 5.58 hotfix
    ReqRefreshCWFriendHandler = 0x018F, // updated 5.58 hotfix

    LinkshellListHandler = 0x03B6, // updated 5.58 hotfix
    CWLinkshellListHandler = 0x0208, // updated 5.58 hotfix
    FellowshipListHandler = 0x02EF, // updated 5.58 hotfix

    CWLinkshellMemberListHandler = 0x03D7, // updated 5.58 hotfix
    ...
    ReqRetainerList = 0x01F9, // updated 5.58 hotfix
    ReqRetainerSaleHistory = 0x01D7, // updated 5.58 hotfix
    ...
    PlaceFieldMarkerPresetHandler = 0x03A2, // updated 5.58 hotfix
    ...
    EventYieldHandler = 0x021D, // updated 5.58 hotfix
