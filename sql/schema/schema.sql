...
CREATE TABLE `charaextracurrency` (
  `CharacterId` int(5) NOT NULL DEFAULT '0',
  `Currency_0` int(5) DEFAULT '0',
  `Currency_1` int(5) DEFAULT '0',
  `Currency_2` int(5) DEFAULT '0',
  `Currency_3` int(5) DEFAULT '0',
  `Currency_4` int(5) DEFAULT '0',
  `Currency_5` int(5) DEFAULT '0',
  `Currency_6` int(5) DEFAULT '0',
  `Currency_7` int(5) DEFAULT '0',
  `Currency_8` int(5) DEFAULT '0',
  `Currency_9` int(5) DEFAULT '0',
  `Currency_10` int(5) DEFAULT '0',
  `Currency_11` int(5) DEFAULT '0',
  `Currency_12` int(5) DEFAULT '0',
  `Currency_13` int(5) DEFAULT '0',
  `Currency_14` int(5) DEFAULT '0',
  `Currency_15` int(5) DEFAULT '0',
  `Currency_16` int(5) DEFAULT '0',
  `Currency_17` int(5) DEFAULT '0',
  `Currency_18` int(5) DEFAULT '0',
  `Currency_19` int(5) DEFAULT '0',
  `Currency_20` int(5) DEFAULT '0',
  `Currency_21` int(5) DEFAULT '0',
  `Currency_22` int(5) DEFAULT '0',
  `Currency_23` int(5) DEFAULT '0',
  `Currency_24` int(5) DEFAULT '0',
  `Currency_25` int(5) DEFAULT '0',
  `Currency_26` int(5) DEFAULT '0',
  `Currency_27` int(5) DEFAULT '0',
  `Currency_28` int(5) DEFAULT '0',
  `UPDATE_DATE` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`CharacterId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
